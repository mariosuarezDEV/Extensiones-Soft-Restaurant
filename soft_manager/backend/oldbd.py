...
class Productpricelists(models.Model):
    ...
    impuesto1 = models.DecimalField(db_column='Impuesto1', max_digits=7, decimal_places=4, blank=True, null=True)  # Field name made lowercase.
    impuesto2 = models.DecimalField(db_column='Impuesto2', max_digits=7, decimal_places=4, blank=True, null=True)  # Field name made lowercase.
    impuesto3 = models.DecimalField(db_column='Impuesto3', max_digits=7, decimal_places=4, blank=True, null=True)  # Field name made lowercase.
...
class Bitacoratarjetacredito(models.Model):
    ...
    businessid = models.CharField(max_length=255)
...
class Cancela(models.Model):
    ...
    procesado = models.BooleanField(blank=True, null=True)
    workspaceid = models.CharField(db_column='WorkspaceId', max_length=36, blank=True, null=True)  # Field name made lowercase.
    cancelaid = models.AutoField(primary_key=True)
...
class Cheqerp(models.Model):
    pk = models.CompositePrimaryKey('folio', 'WorkspaceId')
    folio = models.BigIntegerField()
    enviado = models.BooleanField()
...
class Cheques(models.Model):
    ...
    esaledeliverytype = models.IntegerField(db_column='ESaleDeliveryType')  # Field name made lowercase.
    desc_porc_original = models.DecimalField(max_digits=8, decimal_places=4, blank=True, null=True)
...
class ConfiguracionWs(models.Model):
    ...
    cierremensual_acepta_dias = models.BooleanField()
    cierremensual_num_dias = models.IntegerField()
...
class Perfilesformasdepago(models.Model):
    pk = models.CompositePrimaryKey('idusuariosperfiles', 'idformadepago')
...
# Unable to inspect table 'tempcheques'
# The error was: ('08S01', '[08S01] [Microsoft][ODBC Driver 18 for SQL Server]TCP Provider: Se produjo un error durante el intento de conexión ya que la parte conectada no respondió adecuadamente tras un periodo de tiempo, o bien se produjo un error en la conexión establecida ya que el host conectado no ha podido responder.\r\n (10060) (SQLExecDirectW); [08S01] [Microsoft][ODBC Driver 18 for SQL Server]Communication link failure (10060)')
# Unable to inspect table 'tempchequesinfo'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tempchequespagos'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tempexplosioninsumosdetalle'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tempexplosionproductos'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tempexplosionproductosdetalle'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tempfoliosfacturados'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tempnotificaciones'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tempnumerostarjetas'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tipoclientes'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tipoclientesPriceList'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tipocomisionistas'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tipodescuento'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tipoempresa'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tipoformaspagos'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tipogastos'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tipomenuclientes'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tipopedido'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tipoproveedores'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tiporeservaciones'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tiposdemesa'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tiposdemesadetalles'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'tiposervicio'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'traspasosalmacen'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'turnos'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'turnosf'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'ubicacionesempresa'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'udsmedida'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'udsmedidaequivale'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'usuarios'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'usuariosdescargar'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'usuariosperfiles'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'usuariosperfilescatalogo'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'validahuellamonedero'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'workspace_apps'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'workspace_apps_pricelists'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'workspace_platform_settings'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'workspace_settings'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'ws_cloud'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'xpFormasDePago'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'xpPasoVentaCabecero'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'xpPasoVentaDetalle'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'xpPaso_Insumos'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'zonasdomicilio'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'zonasdomiciliodescargar'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'zonasdomiciliosucursales'
# The error was: The cursor's connection has been closed.
# Unable to inspect table 'zonasempresa'
# The error was: The cursor's connection has been closed.
# This is an auto-generated Django model module.
# You'll have to do the following manually to clean this up:
#   * Rearrange models' order
